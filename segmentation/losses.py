...
from segmentation.utils import calc_dist_map_batch, calc_dist_map_batch_2D, calc_dist_map, calc_dist_map_2D
...
def Weighted_CatCross_Loss_2D(numClasses):
    """
    ...
    def categorical_cross_entropy_2D(y_true, y_pred):
        """
    ...
    return categorical_cross_entropy_2D


def Weighted_CatCross_Loss_3D(numClasses):
    """
    Categorical crossentropy wrapper function between y_pred tensor and a target tensor.
    Arguments:
        numClasses: number of classes
    ...
    def categorical_cross_entropy_3D(y_true, y_pred):
        """
        Computes categorical cross entropy weighted by distance weighted map.
        Args:
            y_true: A tensor of the same shape as `y_pred`.
    ...
    return categorical_cross_entropy_3D
